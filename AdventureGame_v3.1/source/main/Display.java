...
public class Display extends JPanel implements Runnable {
    ...
    public Entity bandit[] = new Entity[15];
    ...
    public void paintComponent(Graphics graphics) {
        ...
        if (keyInput.showDebugText) {
            ...
            int x = tileSize;
            int y = screenHeight - 4 * tileSize;
            int lineHeight = tileSize / 2;

            graphics2D.drawString("MapX: " + hero.mapX, x, y);

            y += lineHeight;
            graphics2D.drawString("MapY: " + hero.mapY, x, y);

            y += lineHeight;
            graphics2D.drawString("Col: " + (hero.mapX + hero.solidArea.x) / tileSize, x, y);

            y += lineHeight;
            graphics2D.drawString("Row: " + (hero.mapY + hero.solidArea.y) / tileSize, x, y);

            y += lineHeight;
            graphics2D.drawString("Draw time: " + drawTime, x, y);
