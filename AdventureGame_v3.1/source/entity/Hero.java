...
public class Hero extends Entity {
    ...
    public void setItems() {
        ...
        inventory.add(new Key(display));
        inventory.add(new Boots(display));
        inventory.add(new Key(display));
        inventory.add(new Boots(display));
        inventory.add(new Key(display));
        inventory.add(new Boots(display));
    ...
    public void update() {
        ...
        if (attacking) {
            ...
            if (keyInput.upPressed ||
                ...
                // int banditIndex = display.collisionDetector.detectEntity(this,
                // display.bandit);
    ...
    public void pickUpObject(int objectIndex) {
        ...
        if (objectIndex != 999) {
            ...
            if (inventory.size() != maxInventorySize) {
                ...
                inventory.add(display.object[objectIndex]);

                text = display.object[objectIndex].name + " picked up!";
            ...
            display.userInterface.addMessage(text);
        }
    }
    ...
    public void damageBandit(int i) {
        ...
        if (i != 999) {
            ...
            if (!display.bandit[i].invincible) {
                ...
                display.userInterface.addMessage("Bandit -1 life!");
                ...
                if (display.bandit[i].life <= 0) {
                    ...
                    display.userInterface.addMessage("Bandit defeated!");
                }
            }
        }
        // else {
    ...
    public void selectItem() {
        int itemIndex = display.userInterface.getItemIndexInSlot();

        if (itemIndex < inventory.size()) {

            Entity selectedItem = inventory.get(itemIndex);

            if (selectedItem.type == consumableObject) {
